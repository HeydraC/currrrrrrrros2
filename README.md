...
Así solveRushHour comprueba que StartBoard sea un estado y carga sus vehículos a la base de conocimientos, ordena la lista para que luego pueda ser comparada con otras, obtiene la solución mediante bfs e invierte la misma para obtener los pasos en el orden correcto.
